...
import { Mail, Lock, ArrowRight, Github, Chrome, Eye, EyeOff, Check, User } from "lucide-react";
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-gray-400 text-lg">
                  Join the obsessively consistent. Create your account below.
                </p>
              </div>
              ...
              <form className="space-y-5" onSubmit={handleRegister}>
                ...
                <div className="flex gap-3 text-xs text-gray-500 animate-in fade-in pt-1">
                  <div
